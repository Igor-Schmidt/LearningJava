...
public class ListaEstatica {
    ...
    private void redimensionar() {
        Object[] novoArray = new Object[this.info.length + 10];
    ...
    public int buscar(int valor) {
        for (int count = 0; count < this.tamanho; count++) {
            if (this.info[count].equals(valor)) {
                return count;
            }
        }
        return -1;
    ...
    public int obterElemento(int posicao) {
        if (posicao >= 0 && posicao < this.tamanho) {
            ...
            return (Integer) this.info[posicao];
        } else {
    ...
    public void inverter() {
        ...
        System.out.println("A lista invertida fica no seguinte formato: " + this.toString());
    }
}
