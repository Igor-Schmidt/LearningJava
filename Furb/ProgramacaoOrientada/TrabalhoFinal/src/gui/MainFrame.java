...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        // Painel do cabeçalho com o nome do aluno
        JPanel headerPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        headerPanel.setBorder(BorderFactory.createEmptyBorder(2, 10, 2, 10));
        JLabel authorLabel = new JLabel("Aluno: Igor Zafriel Schmidt");
